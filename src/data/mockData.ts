...
export const INITIAL_JOBS: JobPosting[] = [
  {
    ...
    rating: 4.9,
    reviewsCount: 128,
    salary: '₹5,40,000 - ₹8,00,000/year + Tips',
    jobType: 'Commission',
    category: 'Hair',
  ...
  },
  {
    ...
    rating: 4.8,
    reviewsCount: 94,
    salary: '₹25,000 - ₹40,000/month + Tips',
    jobType: 'Full-time',
    category: 'Skincare',
  ...
  },
  {
    ...
    rating: 4.7,
    reviewsCount: 88,
    salary: 'Keep 100% Earnings (₹12,000/month chair rent)',
  ...
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 150,
    salary: '₹8,00,000 - ₹12,00,000/year + Profit Share',
    jobType: 'Full-time',
    category: 'Management',
  ...
  },
  {
    ...
    rating: 4.8,
    reviewsCount: 45,
    salary: '₹22,000 - ₹36,000/month + High Tips',
    jobType: 'Full-time',
    category: 'Nails',
  ...
  },
  {
    ...
    rating: 5.0,
    reviewsCount: 210,
    salary: '₹9,00,000 - ₹14,00,000/year + High Commission',
    jobType: 'Commission',
    category: 'Hair',
...
export const INITIAL_APPLICANTS: Applicant[] = [
  {
    ...
    name: 'Priya Sharma',
    appliedJobId: 'job-1',
    appliedJobTitle: 'Senior Hair Stylist',
    ...
    coverNote: 'I have 4 years experience specializing in balayage and bridal styling.',
    portfolioUrl: 'instagram.com/priyastyles',
    avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCFmvdaG8SiaVxq5laV-QM1_6wwlJ2CyE-wBSmxqL9g8cDtrYtcpYKAHnR1_B7UQVh1aczE4v5iBpzscpUAb2LW5WA-FbgpFIkrUoq80WYsFwJrWPIDwih9AhyWyNaD9yu9PjM3Vra5evA-ZcQMuk3VdDb0eQtDnnGVpfVnVgszHbXA_y_L3fvtpDjRgsZkK7OiEY_E4ST06G2_nM2DFM7ZUuARO9BeuRa8nyVZHRLTy8o9BgG7y99c',
    location: 'Malviya Nagar, Jaipur',
    skills: ['Balayage', 'Bridal Makeup', 'Keratin']
  },
  {
    id: 'cand-2',
    name: 'Rahul Desai',
    appliedJobId: 'job-1',
    appliedJobTitle: 'Makeup Artist',
    ...
    coverNote: 'Extensive background in editorial makeup and airbrush techniques.',
    portfolioUrl: 'instagram.com/rahuldesaimakeup',
    avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC2iBsTc1j6QctnL0H7dK_zTDEhOs9XXgdf5OZdTFalH9LlWrZsb6_JYLUA4r9Xgt4JW-bje-i6w4TlRpOubyHvgrLA4QJ5qOnBWEOiTIaVIll3OJ_wn59GKFKyrP3FkfBv2KO0D9zIdnHZDvFN5d8Y_oulYV_2mNH2i7vFe_6bQZzkNX9C4xLbljhRLYEiVrITzRTJ8niyCoMwP03_ScKKbtqun4MP3sIbfeMsAFGsg8WxMfy3bkna',
    location: 'Bandra, Mumbai',
    skills: ['Airbrush', 'Editorial', 'SFX']
  },
  {
    id: 'cand-3',
    name: 'Anjali Nair',
    appliedJobId: 'job-5',
    appliedJobTitle: 'Nail Technician',
    ...
    status: 'Viewed',
    appliedDate: '3 days ago',
    coverNote: 'Passionate about gel art and acrylics.',
    portfolioUrl: 'instagram.com/anjalinails',
    location: 'Indiranagar, Bangalore',
    skills: ['Acrylics', 'Gel Art', 'Manicure']
  }
];
